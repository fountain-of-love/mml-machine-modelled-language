...
REPORT_PATH = ROOT / "docs" / "benchmark" / "results" / "cross-level-semantic-transition-v1.md"
...
def run_experiment() -> dict:
    ...
    return {
        ...
        "artifact_identities": {
            ...
            "intersection_flow_sha256": _sha(ROOT / "combinatorial_uniqueness_flow.py"),
            "transition_operation_sha256": _sha(ROOT / "cross_level_semantic_transition.py"),
