# RCL — Resonant Capacity Law

This folder contains the Resonant Capacity Law work copied under the Seed Vault's `movement/discovery` element. It is an equation-led scientific derivation and the governed knowledge structure around it. It derives Resonant Capacity as a universal representation law for a declared class of stable quadratic two-store systems, then binds the same parent structure to mechanics, second-sound thermodynamics, acoustics, electromagnetism, and hydraulics without changing its frozen definitions and conventions.

The vault is also a foundation for **Machine Modelled Language (MML)**. Its concepts, semantic roles, equations, constraints, provenance, and failure conditions provide the kind of governed scientific structure that a Common Language Model can make addressable. MML could then transpose discoveries recorded in that structure into mathematical weights and task-specific operators, allowing scientific knowledge to participate directly in deterministic mathematical operations.

The present proof is analytical and equation-led rather than encoded in machine-verifiable proof software. Its universality is bounded by the admitted model class; experimental replication and stronger empirical claims outside that class remain separate work.

For the scientific claim, scope, maturity, and novelty boundary, start with the [Claim Ledger](00-governance/Claim-Ledger.md) and continue with the [Five-Domain Analytical Derivation](02-proof/Resonant-Capacity-R3-Certificates.md).

For the broader **Semantic Operating System (SOS)** architecture, see [SOS Architecture](../../../../../sos/Architecture.md). For dual persistence, see [Dual Persistence](../../../../../sos/Dual-Persistence.md). For participation, competing assertions, provenance, and rollback expectations, see [Commons Governance](../../../../../sos/Commons-Governance.md).
...
- [Five-Domain Analytical Derivation](02-proof/Resonant-Capacity-R3-Certificates.md)
