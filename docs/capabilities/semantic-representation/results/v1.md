...
This report follows [OSCARC methodology](../../../benchmark/oscarc-methodology.md). The [machine-readable JSON artifact](../../../../benchmark/results/semantic-representation-v1.json) remains authoritative for measurements, convergence, conformity inputs, artifact identities, and provenance.
