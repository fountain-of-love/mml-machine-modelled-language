...
**Protocol:** [Experiment 3 — Compose the Broad. Resolve the Specific.](experiment.md)
**Reporting method:** [OSCARC v1](../../benchmark/oscarc-methodology.md)
...
```text
src/combinatorial_uniqueness/
  compose_concepts.py
  combinatorial_uniqueness_flow.py

experiments/combinatorial_uniqueness/
  fixture.py
...
### `experiments/combinatorial_uniqueness/fixture.py` — experimental state, manifest, and probe loading
...
### `experiments/combinatorial_uniqueness/combined_benchmark.py` — experiment adapter

This module follows `experiments/knowledge_state_execution/benchmark.py`:
...
### `experiments/combinatorial_uniqueness/demo.py` — human-facing composition root
...
combinatorial-benchmark:
	PYTHONDONTWRITEBYTECODE=1 $(PYTHON) -m experiments.combinatorial_uniqueness.combined_benchmark --write

combinatorial-benchmark-check:
	PYTHONDONTWRITEBYTECODE=1 $(PYTHON) -m experiments.combinatorial_uniqueness.combined_benchmark --check
```
