...
class GovernedSemanticState(Protocol):
    """Structural input contract for compiling an explicit semantic state."""
    ...
    epistemic_positions: Sequence[str]
...
class CombinatorialUniquenessFlow:
    """Compile governed semantic traits and execute inspectable composition prefixes."""

    def govern_and_compile(self, fixture: GovernedSemanticState) -> CompiledSemanticState:
