...
REPORT_PATH = ROOT / "docs" / "capabilities" / "knowledge-state-execution" / "results" / "v1.md"
METHODOLOGY_PATH = ROOT / "docs" / "benchmark" / "oscarc-methodology.md"
KERNEL_PATH = ROOT / "src" / "knowledge_state_execution" / "execute_knowledge_state.py"
FLOW_PATH = ROOT / "src" / "knowledge_state_execution" / "knowledge_is_state.py"
EXPERIMENT_PATH = ROOT / "experiments" / "knowledge_state_execution" / "benchmark.py"
FIXTURE_LOADER_PATH = ROOT / "experiments" / "knowledge_state_execution" / "fixture.py"
...
def markdown_report(result):
    ...
    lines.extend([
        ...
        "This report follows the [OSCARC methodology](../../../benchmark/oscarc-methodology.md). The "
