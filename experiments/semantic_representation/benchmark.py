...
REPORT_PATH = ROOT / "docs" / "capabilities" / "semantic-representation" / "results" / "v1.md"
METHODOLOGY_PATH = ROOT / "docs" / "benchmark" / "oscarc-methodology.md"
KERNEL_PATH = ROOT / "src" / "semantic_representation" / "activate_grounded_focus.py"
FLOW_PATH = ROOT / "src" / "semantic_representation" / "words_carry_weight.py"
COMPARISON_PATH = ROOT / "experiments" / "semantic_representation" / "comparison.py"
FIXTURE_PATH = ROOT / "data" / "demonstration" / "words_carry_weight.json"
GENERATOR_PATH = ROOT / "experiments" / "semantic_representation" / "benchmark.py"
...
def markdown_report(result):
    ...
    lines.extend([
        ...
        "This report follows [OSCARC methodology](../../../benchmark/oscarc-methodology.md). The "
